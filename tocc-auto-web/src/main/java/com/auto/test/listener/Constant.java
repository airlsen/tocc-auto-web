...
public class Constant {
	 ...
	 * productInfo
	 */
	public static String TEST_PRODUCT_B2B_NAME = "多美滋";
	public static String TEST_PRODUCT_B2B_ID = "3065503560103026";
	public static String TEST_PRODUCT_B2C_NAME = "小跃赠品勿动070803";
	public static String TEST_PRODUCT_B2C_ID = "2718226655043059";
	public static String TEST_PRODUCT_XSJ_NAME = "科勒曼";
	public static String TEST_PRODUCT_XSJ_ID = "3653128312497785";

	public static String SIT_PRODUCT_XSJ_NAME = "AVENT飞利浦";
	public static String SIT_PRODUCT_XSJ_ID = "2435841710843066";
	...
	public static String ONL_PRODUCT_B2C_NAME = "日本 merries 花王 纸尿裤 M64片";
	public static String ONL_PRODUCT_B2C_ID = "3098866175861523";
	public static String ONL_PRODUCT_B2B_NAME = "意大利 PAOLA VENDITTI 特级初榨橄榄油 1L";
	public static String ONL_PRODUCT_B2B_ID = "2778550837987761";
	
	public  static  String TEST_RATILER_LOGIN_ID = "12630";
	public  static  String SIT_RATILER_LOGIN_ID = "2181";
	public static final String TEST_RATILER_LOGIN_NAME = "15810838139";
	public static final String SIT_RATILER_LOGIN_NAME = "15810838139";
	/**
	 * system
	 */
	 ...
	 * xsj
	 */
	public static final String TEST_XSJ_ADD_SHOPPING_CART_FAIL = "XSJ-下单-加入购物车测试用例执行失败";
	/**
	 * supplier
	 */
