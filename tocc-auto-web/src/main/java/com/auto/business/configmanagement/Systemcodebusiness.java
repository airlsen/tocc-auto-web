 ...
 *
 */
public class Systemcodebusiness extends Globalbusiness {
	
	public static String TipInformation;
	private static Logger log = Logger.getLogger(Systemcodebusiness.class.getName());
	/**
	 * 初始化对象
	 * @throws Exception 
	 */
	public Systemcodebusiness(WebDriver driver,String function)  {
	...
	public String add(String codeValue,String codeName,String standard,String field,String remark,String codetype,
		...
		log.info("------------------------配置管理--系统代码管理--添加功能");
		log.info("预期结果：   "+expected);
		//系统代码管理
		outFrame();
		click(yaml.getElement("系统代码管理"));
		inFrame("APP-PZGL-SJZD-XTDM");
		//click添加		
